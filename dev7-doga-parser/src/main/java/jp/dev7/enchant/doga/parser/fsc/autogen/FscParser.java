/* Generated By:JJTree&JavaCC: Do not edit this line. FscParser.java */
package jp.dev7.enchant.doga.parser.fsc.autogen;
public class FscParser/*@bgen(jjtree)*/implements FscParserTreeConstants, FscParserConstants {/*@bgen(jjtree)*/
 ...
 /*@bgen(jjtree) Num */
  ...
  public FscParserTokenManager token_source;
  ...
  public FscParser(java.io.InputStream stream) {
     this(stream, null);
  }
  /** Constructor with InputStream and supplied encoding */
  public FscParser(java.io.InputStream stream, String encoding) {
    try { jj_input_stream = new SimpleCharStream(stream, encoding, 1, 1); } catch(java.io.UnsupportedEncodingException e) { throw new RuntimeException(e); }
    token_source = new FscParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Constructor. */
  public FscParser(java.io.Reader stream) {
  ...
  public FscParser(FscParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jj_gen = 0;
  ...
  /** Reinitialise. */
  public void ReInit(FscParserTokenManager tm) {
    token_source = tm;
    token = new Token();
    jj_ntk = -1;
    jjtree.reset();
