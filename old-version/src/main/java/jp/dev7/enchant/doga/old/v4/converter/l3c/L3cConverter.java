package jp.dev7.enchant.doga.old.v4.converter.l3c;
...
import jp.dev7.enchant.doga.old.v4.converter.EnchantArticulated;
import jp.dev7.enchant.doga.old.v4.converter.EnchantMesh;
import jp.dev7.enchant.doga.old.v4.converter.EnchantPose;
import jp.dev7.enchant.doga.old.v4.converter.EnchantPoseUnit;
import jp.dev7.enchant.doga.old.v4.converter.EnchantUnit;
import jp.dev7.enchant.doga.old.v4.converter.l3p.L3pConverter;
import jp.dev7.enchant.doga.old.v4.converter.suf.SufConverter;
import jp.dev7.enchant.doga.old.v4.parser.l3c.L3cFileParser;
import jp.dev7.enchant.doga.old.v4.parser.l3c.PoseLineParser;
import jp.dev7.enchant.doga.old.v4.parser.l3c.data.L3c;
import jp.dev7.enchant.doga.old.v4.parser.l3c.data.Pose;
...
public class L3cConverter {
	...
	public EnchantArticulated convert(File l3cFile) throws Exception {
		...
		// モデルデータ
		final Unit root = l3c.getRootUnit();
	...
	private EnchantUnit convert(Unit unit, L3pConverter l3pConverter,
		...
		for (Unit child : unit.getChildUnits()) {
	...
	private String l3pFileName(Unit unit) {
	...
	private Matrix4d scale(Unit unit) {
	...
	private Matrix4d mov(Unit unit) {
		final Matrix4d result = Utils.getIdentity();
	...
	private double[] basePosition(Unit unit) {
		return new double[] {
				// mov
	...
	private double[] initialPose(Unit unit) {
		return new double[] {
				// rot
